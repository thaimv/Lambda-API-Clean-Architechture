...
Clean Architecture monorepo with two Lambda entry points: **Public REST API** and **AppSync GraphQL API**.
...
| File                 | Handler          | Module                |
| -------------------- | ---------------- | --------------------- |
| `public-rest-api.ts` | API Gateway REST | `PublicRestApiModule` |
...
| File                        | Lambda  | Imports                                           |
| --------------------------- | ------- | ------------------------------------------------- |
| `public-rest-api.module.ts` | REST    | `CommonUserRepo`, `UsersRestModule`, `AppConfig`  |
| `appsync-api.module.ts`     | GraphQL | `CommonUserRepo`, `UsersGraphModule`, `AppConfig` |
...
| Module   | REST        | GraphQL                   |
| -------- | ----------- | ------------------------- |
| `users/` | `GET /user` | `createUserInfo` mutation |
...
Datasource DI modules live in `src/config/di/datasources/`. Common repo DI modules live in `src/config/di/repos/`. Only modules imported by `PublicRestApiModule` / `AppsyncApiModule` are wired at runtime.
...
```
tests/unit-test/modules/users/stubs/user.stub.ts
tests/unit-test/modules/users/controllers/*.test.ts
tests/unit-test/modules/users/repos/*.test.ts
tests/unit-test/modules/users/usecases/*.test.ts
```
