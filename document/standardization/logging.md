...
| `ApiLoggingPipe`     | `public-rest-api` | `src/common/lambda/pipes/api-logging.pipe.ts`     |
...
// public-rest-api.ts (via Lambda class)
...
logger.debug('UsersRepo.saveUser', { userId: authUser.userId });
```
