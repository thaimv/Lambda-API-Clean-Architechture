export const DI = {
  ...
  DB_CLIENT_DATASOURCE: Symbol.for('IDBClient'),
  TRANSACTION_RUNNER_DATASOURCE: Symbol.for('ITransactionRunner'),
  ...
  CACHE_DATASOURCE: Symbol.for('ICacheServiceDatasource'),
  API_GATEWAY_DATASOURCE: Symbol.for('ApiGatewayDatasource'),
  PUSH_NOTIFICATION_DATASOURCE: Symbol.for('INotificationServiceDatasource'),
