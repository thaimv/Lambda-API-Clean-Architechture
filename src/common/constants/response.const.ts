/**
 * Result code
 * @description Result code is used to identify the result of the lambda function.
 * @description It is use for API/Event response only.
 * @description It is not used for GraphQL response.
 */
...
export const ERROR_MESSAGE = {
  ...
  USER_NICKNAME_ALREADY_EXISTS: 'userNickname already exists',
};
