...
/**
 * Enum defining the paths for Public Rest API endpoints.
 */
...
/**
 * Auth API Gateway endpoints (separate REST API from public-api).
 */
export enum PathAuthApi {
  PostCredential = '/auth/credential',
}
