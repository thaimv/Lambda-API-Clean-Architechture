...
| E2E tests (single API) | `lambda-generate-api-tests`     |
| E2E tests (feature)    | `lambda-generate-feature-tests` |
| Unit tests (module)    | `lambda-generate-unit-tests`    |

Example prompts (no `/` needed):

- _Review PR #42_
- _Implement createUserInfo from `document/detail-designs/graphql/user/createUserInfo.md`_
- _Generate E2E tests for createUserInfo detail design_
